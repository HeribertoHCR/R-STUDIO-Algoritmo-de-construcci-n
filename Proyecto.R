...
# Lectura de datos
excelM <- "C:\\Users\\v0609\\OneDrive\\Documentos\\Univesidad\\7mo Semestre\\Admin. de la producción\\MAQUINA.xlsx"
MatVia <- as.matrix(read_excel(excelM, sheet = 'Hoja1', range = "A1:E6"))
MatDis <- as.matrix(read_excel(excelM, sheet = 'Hoja2', range = "A1:E6"))
